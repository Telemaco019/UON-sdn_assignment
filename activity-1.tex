...
meet the requirements. To conclude, answer the questions proposed in the task 8.

This lab activity assumes you are proficient in SDN networks and Mininet network
emulator. A basic knowledge of the Python programming language is also assumed.

The activity was designed taking inspiration from the script \cite{ref-3} included in the 
examples available on GitHub provided by Mininet.
